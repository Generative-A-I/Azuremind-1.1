...
type Props = { messages: Message[]; loading: boolean; effort: EffortLevel; version: AzuremindVersion; connected: boolean; product?: 'chat' | 'code'; onEffortChange: (value: EffortLevel) => void; onVersionChange: (value: AzuremindVersion) => void; onSend: (text: string, attachment?: AttachmentPayload) => void }

export function ChatArea({ messages, loading, effort, version, connected, product = 'chat', onEffortChange, onVersionChange, onSend }: Props) {
